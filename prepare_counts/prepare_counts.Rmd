...
counts$rna <- ifelse(counts$rna_species %in% c("pirna"), base::gsub("_(gb).*", " etc.", counts$rna), counts$rna)
...
# shorten pirna names for plotting sakes
rownames(raw_pirna_excerpt_data) <- base::gsub("_(gb).*", " etc.", rownames(raw_pirna_excerpt_data))
