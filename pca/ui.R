...
ui <- fluidPage(
  ...
  verticalLayout(
    ...
    wellPanel(
      ...
      selectizeInput("dimension_choice",
    ...
    wellPanel(style = "padding: 80px;",
              
              bscols(plotlyOutput(outputId = "scree_plot"), dataTableOutput("table_scree"), widths = c(5,6))
    ),
    
    wellPanel(style = "padding: 80px;",
              
              bscols(plotlyOutput(outputId = "variables_plot"), dataTableOutput("table_variables"), widths = c(5,7))
    ...
    wellPanel(style = "padding: 80px;",
              ...
              bscols(plotlyOutput(outputId = "individuals_plot"), dataTableOutput("table_individuals"), widths = c(5,7))
    )
