...
```{r, results = "asis"}
base::cat(base::paste0("RNA's found to be significantly differentially expressed (with a p-value less than ", config$pvalue_cutoff, " and a log fold change greater than ", config$min_lfc ,") by the [limma/voom](https://genomebiology.biomedcentral.com/articles/10.1186/gb-2014-15-2-r29) differential expression method are reported here."))
```
...
```{r, results = "asis"}
base::cat(base::paste0("RNA's found to be significantly differentially expressed (with a p-value less than ", config$pvalue_cutoff, " and a log fold change greater than ", config$min_lfc ,") by the [deseq2](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-014-0550-8) differential expression method are reported here."))
```
...
```{r, results = "asis"}
base::cat(base::paste0("RNA's found to be significantly differentially expressed (with a p-value less than ", config$pvalue_cutoff, " and a log fold change greater than ", config$min_lfc ,") by both the [limma/voom](https://genomebiology.biomedcentral.com/articles/10.1186/gb-2014-15-2-r29) and the [deseq2](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-014-0550-8) differential expression method are reported here."))
```
