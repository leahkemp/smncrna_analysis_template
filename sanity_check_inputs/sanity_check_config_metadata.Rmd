...
if (file.exists(config$smrnaseq_results_dir) == FALSE) {
...
if (file.exists(config$excerpt_results_dir) == FALSE) {
  
  issues_config <- c(issues_config, base::paste0("Directory passed to 'excerpt_results_dir' in the configuration file doesn't exist."))
  
}

if (file.exists(config$excerpt_merged_results_dir) == FALSE) {
  
  issues_config <- c(issues_config, base::paste0("Directory passed to 'excerpt_merged_results_dir' in the configuration file doesn't exist."))
