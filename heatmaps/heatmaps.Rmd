...
if (all(is.na(lcpm_mirna_smrnaseq)) == FALSE & nrow(lcpm_mirna_smrnaseq) > 3) {
...
} else if (all(is.na(lcpm_mirna_smrnaseq)) == FALSE & nrow(lcpm_mirna_smrnaseq) < 3) {
  cat(paste("Too few significantly differentially expressed miRNA's to cluster in a PCA"))
} else if (all(is.na(lcpm_mirna_smrnaseq)) == TRUE) {
...
# if there ARE significantly differentially expressed RNA's (and there are more than two of them), create a heatmap
# if there AREN'T significantly differentially expressed RNA's, print a message saying so
if (all(is.na(lcpm_mirna_excerpt)) == FALSE & nrow(lcpm_mirna_excerpt) > 3) {
...
} else if (all(is.na(lcpm_mirna_excerpt)) == FALSE & nrow(lcpm_mirna_excerpt) < 3) {
  cat(paste("Too few significantly differentially expressed miRNA's to cluster in a PCA"))
} else if (all(is.na(lcpm_mirna_excerpt)) == TRUE) {
  cat(paste("No significantly differentially expressed miRNA's"))
} else {
  cat(paste("No significantly differentially expressed miRNA's)"))
}
...
# if there ARE significantly differentially expressed RNA's (and there are more than two of them), create a heatmap
# if there AREN'T significantly differentially expressed RNA's, print a message saying so
if (all(is.na(lcpm_pirna_excerpt)) == FALSE & nrow(lcpm_pirna_excerpt) > 3) {
...
} else if (all(is.na(lcpm_pirna_excerpt)) == FALSE & nrow(lcpm_pirna_excerpt) < 3) {
  cat(paste("Too few significantly differentially expressed piRNA's to cluster in a PCA"))
} else if (all(is.na(lcpm_pirna_excerpt)) == TRUE) {
...
# if there ARE significantly differentially expressed RNA's (and there are more than two of them), create a heatmap
# if there AREN'T significantly differentially expressed RNA's, print a message saying so
if (all(is.na(lcpm_trna_excerpt)) == FALSE & nrow(lcpm_trna_excerpt) > 3) {
...
} else if (all(is.na(lcpm_trna_excerpt)) == FALSE & nrow(lcpm_trna_excerpt) < 3) {
  cat(paste("Too few significantly differentially expressed tRNA's to cluster in a PCA"))
} else if (all(is.na(lcpm_trna_excerpt)) == TRUE) {
...
# if there ARE significantly differentially expressed RNA's (and there are more than two of them), create a heatmap
# if there AREN'T significantly differentially expressed RNA's, print a message saying so
if (all(is.na(lcpm_circrna_excerpt)) == FALSE & nrow(lcpm_circrna_excerpt) > 3) {
...
} else if (all(is.na(lcpm_circrna_excerpt)) == FALSE & nrow(lcpm_circrna_excerpt) < 3) {
  cat(paste("Too few significantly differentially expressed circRNA's to cluster in a PCA"))
} else if (all(is.na(lcpm_circrna_excerpt)) == TRUE) {
...
# if there ARE significantly differentially expressed RNA's (and there are more than two of them), create a heatmap
# if there AREN'T significantly differentially expressed RNA's, print a message saying so
if (all(is.na(lcpm_gencode_excerpt)) == FALSE & nrow(lcpm_gencode_excerpt) > 3) {
...
} else if (all(is.na(lcpm_gencode_excerpt)) == FALSE & nrow(lcpm_gencode_excerpt) < 3) {
  cat(paste("Too few significantly differentially expressed gencodes to cluster in a PCA"))
} else if (all(is.na(lcpm_gencode_excerpt)) == TRUE) {
  cat(paste("No significantly differentially expressed gencodes"))
} else {
  cat(paste("No significantly differentially expressed gencodes)"))
}
```
