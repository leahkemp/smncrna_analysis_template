...
fig_height_mirna_smrnaseq <- base::nrow(log_counts_per_million$lcpm_mirna_smrnaseq_data) / 6
fig_height_mirna_excerpt <- base::nrow(log_counts_per_million$lcpm_mirna_excerpt_data) / 6
fig_height_pirna_excerpt <- base::nrow(log_counts_per_million$lcpm_pirna_excerpt_data) / 6
fig_height_trna_excerpt <- base::nrow(log_counts_per_million$trna_excerpt) / 6
fig_height_circrna_excerpt <- base::nrow(log_counts_per_million$lcpm_circrna_excerpt_data) / 6
fig_height_gencode_excerpt <- base::nrow(log_counts_per_million$lcpm_gencode_excerpt_data) / 6
