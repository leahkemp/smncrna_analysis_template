...
- *Then for each combination of sample and pipeline, the total RNA's identified are calculated. This is then used to calculate 'Percentage of all RNA's identified' in the given treatment and pipeline*
