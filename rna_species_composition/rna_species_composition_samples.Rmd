...
- *For each combination of sample and pipeline, the total number of RNA counts are calculated for each RNA species to give 'Raw count'*
- *Then for each combination of sample and pipeline, the total RNA's identified are calculated (by summing 'Raw count'). This is then used to calculate 'Percentage of all RNA's identified' of an RNA species for a given sample*
